...
class Channel:
    ...
    def rayleigh_fading(self, signal, snr_db):
        # source: https://pysdr.org/content/multipath_fading.html
...
if __name__ == "__main__":
    ...
    ch = Channel(num_tx_antennas=1,num_rx_antennas=1,channel_type='rayleigh',seed=42)
    ch.generate_channel_matrix()
    print(ch.get_channel_matrix())
    ch.apply_channel(signal = bits, snr_db = 10)

    ch.rayleigh_fading(signal = bits, snr_db = 10)